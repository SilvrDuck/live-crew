...
from live_crew.timeslice import slice_index, SLICE_MS
...
class TestSliceMS:
    """Test cases for SLICE_MS constant."""

    def test_slice_ms_default_value(self):
        """Test SLICE_MS has the correct default value."""
        assert SLICE_MS == 500

    def test_slice_ms_is_int(self):
        """Test SLICE_MS is an integer."""
        assert isinstance(SLICE_MS, int)
...
class TestSliceIndexEdgeCases:
    ...
    def test_slice_index_exact_boundaries(self):
        ...
        for i in range(10):
            ...
            assert slice_index(ts, epoch0) == i
    ...
    def test_slice_index_large_time_differences(self):
        ...
        assert slice_index(ts_1year, epoch0) == expected_slices
